                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a class="d-block card-header py-3">
                            ...
                            <c:choose>
                                <c:when test="${test eq '1'}">
                                    <h6 class="m-0 font-weight-bold text-primary text-center">요청사항 수정</h6>
                                </c:when>
                                <c:otherwise>
                                    <h6 class="m-0 font-weight-bold text-primary text-center">요청사항 등록</h6>
                                </c:otherwise>
                            </c:choose>
                        </a>
                        ...
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">
                                ...
                                <c:choose>
                                <c:when test="${test eq '1'}">
                                <form method="post" action="request_update.do?post_num=${PostList.post_num}" id="requestupdateform"
                                      enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                    </c:when>
                                    <c:otherwise>
                                    <form method="post" action="request_insert.do" id="requestwriteform"
                                          enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                        </c:otherwise>
                                        </c:choose>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <input type="text" id="nor_tit" name="nor_tit" maxlength="40" placeholder="제목을 입력해주세요."
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <textarea name="nor_cnt" id="nor_cnt" rows="9" maxlength="1000"
                                                          placeholder="요청사항 내용을 입력해주세요."
                                    ...
                                    <script>
                                        function chk_form() {
                                            if (document.getElementById("nor_tit").value == '' || document.getElementById("nor_cnt").value == '') {
                                                ...
                                                <c:choose>
                                                <c:when test="${test eq '1'}">
                                                document.getElementById('requestupdateform').submit();
                                                </c:when>
                                                <c:otherwise>
                                                document.getElementById('requestwriteform').submit();
                                                </c:otherwise>
                                                </c:choose>
                                            }
                                        }
