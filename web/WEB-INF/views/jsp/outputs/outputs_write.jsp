                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">
                                ...
                                <c:choose>
                                <c:when test="${test eq '1'}">
                                <form method="post" action="outputs_update.do?post_num=${PostList.post_num}" id="outputsupdateform"
                                      enctype="application/x-www-form-urlencoded" class="form-horizontal">
                                    </c:when>
                                    <c:otherwise>
                                    <form method="post" action="outputs_insert.do" id="outputswriteform"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <input  id="nor_tit" name="title" maxlength="40" placeholder="제목을 입력해주세요."
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-7">
                                                <textarea name="contents" id="nor_cnt" rows="9"
                                                          placeholder="산출물 내용을 입력해주세요." maxlength="1000"
