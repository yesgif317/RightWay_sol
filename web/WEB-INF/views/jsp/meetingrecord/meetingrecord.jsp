        ...
        <div class="container-fluid">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">회의록 게시판 목록</h6>
                </div>
                <div class="card-body"  >
                    <div class="table-responsive" >
                        <table class="table table-bordered table-hover row-border" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <c:forEach items="${PostList}" var="post">
                                <c:if test="${post.cate eq 2}">
                                <tr>
                                    <td>${post.post_num}</td>
                                    <td><a href ="meetingrecord_content.do?post_num=${post.post_num}">${post.nor_tit}</a></td>
                                    <td>${post.cus_num}</td>
                        ...
                        <div style="text-align: center">
                            <a href="/meetingrecord_write.do?update=0&post_num=0" class="btn btn-primary btn-icon-split">
