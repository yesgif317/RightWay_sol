            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover row-border" id="dataTable" width="100%"
                               cellspacing="0">
                            <thead>
                            <tr>
                                <th width="10%">번호</th>
                            ...
                            <c:forEach items="${PostList}" var="post">
                                ...
                                <tr onClick="location.href='meetingrecord_content.do?post_num=${post.post_num}'">
                                        <td>${post.post_num}</td>
                                        <td>${post.nor_tit}</td>
                                        <td>${post.cus_name}</td>
