...
<div id="content-wrapper" class="d-flex flex-column" >
    ...
    <div id="content">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <form method="post" action="/issue_delete.do" id="deleteform">
                        <input type="hidden" name="_method" value="delete" />
                        <input type="hidden" name="post_num" value="${RiskList.post_num}" />
                        ...
                        <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form autocomplete="off" method="post" role="form">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-3"></div>
                                            <div class="col-4 ">
                                                <small class="help-block form-text">이슈번호</small>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-4 ">
                                                ...
                                                <c:choose>
                                                    <c:when test="${RiskList.risk_imp eq 'Emergency'}">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-3"></div>
                                            <div class="col-4 ">
                                                <small class="help-block form-text">이슈 발생일</small>
                                            ...
                                            <div class="col-4" >
                                                <small class="help-block form-text">이슈 해결일</small>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-4 ">
                                                ...
                                                <input style="border:0 solid whitesmoke;width:100%" placeholder="-" type="text" id="issue_ID" name="issue_ID" value="${RiskList.cus_name}/${RiskList.cus_position}" readonly="readonly" disabled/>
                                            </div>
                                            <div class="col-4" >
                                            </div>
                                        </div>
                            ...
                            <div class="text-center d-block card-header py-3">
                                <c:if test="${login.cus_num eq RiskList.cus_num || login.cus_num eq RiskList.risk_mng}">
