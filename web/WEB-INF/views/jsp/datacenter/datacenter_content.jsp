                ...
                <div class="col-lg-12">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a class="d-block card-header py-3"  style="text-align: center">
                            <h6 class="m-0 font-weight-bold text-primary"> ${PostList.title}
                            </h6>
                        </a>
                                ...
                                <form autocomplete="off" method="post" role="form">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-4 ">
                                            ...
                                            <input style="border:0 solid whitesmoke;" type="text" id="writer" name="writer" value="${PostList.writer}" readonly="readonly" disabled/>
                                        </div>
                                        <div class="col-4" >
                                            <small class="help-block form-text">작성일</small>
                                            <input style="border:0 solid whitesmoke; width:100%;"  id="date" name="date" value="${PostList.refdate}" readonly="readonly" disabled/>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-8" style="border-top:  2px solid #808080;border-bottom: 2px solid #808080;">
                                            <textarea style="border:0 solid whitesmoke;" name="contents" id="contents" rows="5" class="form-control mt-3 mb-3" readonly="readonly" disabled>${PostList.contents}</textarea>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="text-center d-block card-header py-3">
                            <a href="outputs_update.do?no=${PostList.no}" class="btn btn-info">
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <button href="outputs_delete.do?no=${PostList.no}" type="button" class="btn btn-primary">삭제하기</button>
