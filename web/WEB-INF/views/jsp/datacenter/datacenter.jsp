                    ...
                    <div class="table-responsive" >
                        <table class="table table-bordered table-hover row-border" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <c:forEach items="${PostList}" var="post">
                                ...
                                <tr>
                                    <td>${post.post_num}</td>
                                    <td><a href ="datacenter_content.do?post_num=${post.post_num}">${post.nor_tit}</a></td>
                                    <td>${post.cus_num}</td>
                        ...
                        <div style="text-align: center">
                            <a href="/datacenter_write.do?update=0&post_num=0" class="btn btn-primary btn-icon-split">
