                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="collapse show" id="collapseCardExample">
                            <div class="card-body">
                                <c:choose>
                                <c:when test="${test eq '1'}">
                                <form method="post" action="notice_update.do" id="noticeupdateform"
                                      enctype="multipart/form-data" class="form-horizontal">
                                    </c:when>
                                    <c:otherwise>
                                    <form method="post" action="notice_insert.do" id="noticewriteform"
                                          enctype="multipart/form-data" class="form-horizontal">
                                        </c:otherwise>
                                        </c:choose>
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-7"><input type="text" id="title" name="title"
                            ...
                            <div class="text-center d-block card-header py-3">
                                ...
                                <a <%--href="javascript:goSubmit();"--%> onclick="return chk_form()"
                                                                         class="btn btn-info">
                                    ...
                                    <span class="text" style="color:white">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <span class="text" style="color:white" id="uploadBtn"
                                                      onclick="chk_form()">등록</span>
                                            </c:otherwise>
                                        </c:choose>
                                    </span>
                                    <script>
